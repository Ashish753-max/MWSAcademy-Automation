...
public class Overview_PlatformAdmin {
...
ChromeDriver driver = new ChromeDriver();
		...
		// click on platform admin
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"root\"]/div[2]/div/main/div/div/div/a[2]"))).click();
