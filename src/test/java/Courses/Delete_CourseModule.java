...
public class Delete_CourseModule {
...
ChromeDriver driver = new ChromeDriver();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"app-scroll-container\"]/div/div/main/div/div/div/div[1]/div[2]/button[2]"))).click();
