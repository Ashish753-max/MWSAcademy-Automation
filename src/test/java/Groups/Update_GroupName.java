...
ChromeDriver driver = new ChromeDriver();
		...
		//click on group name field and update the name
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("/html/body/div[2]/div[2]/div[2]/form/div[1]/div/div[1]/div[1]/input"))).clear();
		Thread.sleep(2000);
		
		// enter new group name
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("/html/body/div[2]/div[2]/div[2]/form/div[1]/div/div[1]/div[1]/input"))).sendKeys("Updated Group Name");
