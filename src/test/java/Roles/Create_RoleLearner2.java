...
public class Create_RoleLearner2 {
...
ChromeDriver driver = new ChromeDriver();
		...
		// enter role name
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[1]/div[1]/input"))).sendKeys("Nurse");
		
		// select permissions
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div[2]/div[2]/div/div[2]/div[2]/div/div[2]/div/button/div"))).click();
        ...
        String screenshotPath = "screenshots/Create_RoleLearner2.png";
