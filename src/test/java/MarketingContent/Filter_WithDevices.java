...
public class Filter_WithDevices {
...
ChromeDriver driver = new ChromeDriver();
		...
		// click on Device filter button
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"app-scroll-container\"]/div/div/div/div/div[2]/div/div/button"))).click();
		
		// select device from the list
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"app-scroll-container\"]/div/div/div/div/div[2]/div/div/div/div[2]/div/button[2]"))).click();
        ...
        String screenshotPath = "screenshots/Filter_WithMarketingDevice.png";
