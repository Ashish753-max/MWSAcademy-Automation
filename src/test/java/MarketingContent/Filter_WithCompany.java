...
public class Filter_WithCompany {
...
ChromeDriver driver = new ChromeDriver();
		...
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"app-scroll-container\"]/div/div/div/div/div[1]/div/div/button"))).click();
		
		// select company from filter
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"app-scroll-container\"]/div/div/div/div/div[1]/div/div/div/div[2]/div/button[2]"))).click();
        ...
        String screenshotPath = "screenshots/Filter_WithCompanyMarketing.png";
