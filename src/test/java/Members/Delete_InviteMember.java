...
public class Delete_InviteMember {
...
ChromeDriver driver = new ChromeDriver();
		...
		// click on the Delete button of the team member
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"admin-scroll-container\"]/div/div/main/div/div/div/div[1]/div/div/div/table/tbody/tr[1]/td[6]/div/button[5]"))).click();
        ...
        String screenshotPath = "screenshots/Delete_TeamMember.png";
