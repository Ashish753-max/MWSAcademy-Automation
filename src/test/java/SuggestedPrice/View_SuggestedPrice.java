...
public class View_SuggestedPrice {
...
ChromeDriver driver = new ChromeDriver();
		...
		// click on view details button
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"app-scroll-container\"]/div/div/main/div/div/div/div[1]/div/div/div/table/tbody/tr[1]/td[6]/div/button[1]"))).click();
